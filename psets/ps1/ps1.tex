...
\noindent{{\bf 1} Define the order relation $<$ on $\BZ$ using only the addition structure(s)\footnote{note that this includes subtraction and you are \textit{given} (0,1)} on $\BZ$}
