...
\title{M11482 Problem Set $3$}%Change the PSet number as needed.
\date{\today}
...
\noindent{{\bf 1. Topological basis for metric spaces.} Show the open balls of a metric space $(X,d)$ form a basis for the topology of the metric space.}

\medskip

\noindent{{\bf 2. Basis of a topology "spans" open sets} Given a basis $\mathscr{B}$ for the topological space $(X,\tau)$, show every open set of $X$ is a union of basis elements.}

\medskip

\noindent{{\bf 3. Metric $\implies$ Hausdorff} Show that metric spaces are also Hausdorff spaces.}

\medskip

\noindent{{\bf 4. Unique Limit Points} Show Hausdorff spaces have unique limits of sequences.}
